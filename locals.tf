...
data "aws_secretsmanager_secret_version" "home_wifi_password" {
  secret_id = "mikrotik/devries-family-network/wifi-passwords" # Replace with your actual secret name or ARN
}
...
locals {
  ...
  home_wifi_password  = jsondecode(data.aws_secretsmanager_secret_version.home_wifi_password.secret_string)["home_wifi_password"]
  guest_wifi_password = jsondecode(data.aws_secretsmanager_secret_version.home_wifi_password.secret_string)["guest_wifi_password"]
  iot_wifi_password   = jsondecode(data.aws_secretsmanager_secret_version.home_wifi_password.secret_string)["iot_wifi_password"]
